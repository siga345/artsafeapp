...
const navLinks = [
  { href: "/today", label: "Путь артиста", icon: Home },
  ...
  { href: "/id", label: "Мир артиста", icon: UserCircle2 }
];
...
function AppShellContent({ children }: { children: React.ReactNode }) {
  ...
  const isChromelessRoute = pathname === "/signin" || pathname === "/signup" || pathname === "/welcome";
  const showBottomNav = !isChromelessRoute;
    ...
    >
            ...
            <Link href="/today" className="flex items-center gap-2.5 md:gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] leading-tight text-brand-muted md:text-xs">
                  Мир артиста и путь артиста. Карьера шире песен, а система не убивает творчество.
                </p>
              </div>
            </Link>
      ...
      <main
        className={cn(
          ...
          isChromelessRoute ? "py-4 md:py-6" : "py-4 md:py-8"
        )}
      >
        {children}
      </main>
