...
const STEPS = [
  {
    title: "Основа",
    description: "Собери базовые данные, с которых начинается не профиль, а артистическая система."
  },
  {
    title: "Опоры",
    description: "Зафиксируй смыслы, образ, аудиторию и направление, а не только песни."
  },
  {
    title: "Визуал",
    description: "Заполни два канонических визуальных борда, чтобы персонаж и образ стали читаемыми."
  },
  {
    title: "Плейлист",
    description: "Оставь внешнюю ссылку на плейлист, который держит музыкальное направление в фокусе."
  }
] as const;
      ...
      <div className="flex min-h-[68vh] flex-col items-center justify-center px-4">
        <div className="max-w-lg text-center">
          ...
          <p className="mt-3 text-base leading-7 text-brand-muted">
            Сначала соберём текстовую основу, затем визуал и плейлист. После этого у тебя появится цельная структура мира артиста внутри системы ASP.
          </p>
  ...
  return (
    <div className="flex min-h-[68vh] items-center justify-center px-4 py-8">
      <div className="w-full max-w-4xl rounded-[32px] border border-[#d7e3cb] bg-[linear-gradient(180deg,rgba(255,255,255,0.94)_0%,rgba(244,249,237,0.98)_100%)] p-5 shadow-[0_24px_60px_rgba(59,77,49,0.12)] md:p-7">
        ...
        <div className="mb-6 rounded-[28px] border border-[#d8e2cc] bg-[#f8fbf4] p-4 text-sm leading-6 text-[#2a342c]">
          <p className="font-medium">Ты строишь не просто песни.</p>
          <p className="mt-1">
            Этот мастер помогает собрать систему смысла, образа, аудитории, контента и направления, которая будет вести карьеру дальше.
          </p>
        </div>
