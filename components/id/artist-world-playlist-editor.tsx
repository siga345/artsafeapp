      ...
      <div className="space-y-3 rounded-2xl border border-brand-border bg-[#f9fbf6] p-4">
        <div>
          ...
          <p className="text-xs text-brand-muted">
            Плейлист нужен как музыкальная опора направления, а не как замена смыслу, образу или аудитории.
          </p>
        </div>
        ...
        {hasUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-[#cbdab8] bg-[#f5faeb] px-4 py-3 text-sm font-medium text-[#4b6440] transition-colors hover:bg-[#ecf4df] sm:w-auto"
          >
